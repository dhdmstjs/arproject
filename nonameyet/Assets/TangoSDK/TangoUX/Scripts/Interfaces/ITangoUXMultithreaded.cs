//-----------------------------------------------------------------------
// <copyright file="ITangoUXMultithreaded.cs" company="Google">
//
...
/// <summary>
/// Tango Ux event interface where the handler will be invoked from multiple threads.
/// 
...
/// </summary>
public interface ITangoUXMultithreaded
{
    /// <summary>
    ...
    void OnUxExceptionEventMultithreadedAvailableEventHandler(Tango.UxExceptionEvent exceptionEvent);
}
