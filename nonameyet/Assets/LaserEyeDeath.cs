...
public class RaycastShootComplete : MonoBehaviour {
	...
	private WaitForSeconds shotDuration = new WaitForSeconds(0.07f); //this should be continuous	// WaitForSeconds object used by our ShotEffect coroutine, determines time laser line will remain visible
...
//			nextFire = Time.time + fireRate;
			...
			//change this to shoot out of guard
			Vector3 rayOrigin = tango.ViewportToWorldPoint (new Vector3(0.5f, 0.5f, 0.0f));
